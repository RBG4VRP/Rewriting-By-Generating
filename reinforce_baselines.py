...
import copy
from pretrain_train import rollout, get_inner_model
...
class BaselineDataset(Dataset):
    ...
    #     self.dataset = dataset
    #     self.baseline = baseline
    #     self.n1=self.dataset.K*self.dataset.batchsize
    #     print('lengths={},{}'.format(len(self.dataset),len(self.baseline)))
    #     assert (len(self.dataset)*self.n1 == len(self.baseline))

    # def __getitem__(self, item):
    #     return {
    #         'data': self.dataset[item],
    #         'baseline': self.baseline[item*self.n1:(item+1)*self.n1]
    #     }
    ...
    def __init__(self, dataset=None, baseline=None):
        ...
        self.dataset = dataset
        self.baseline = baseline
        print('baseline init, avg cost=', baseline.mean())
